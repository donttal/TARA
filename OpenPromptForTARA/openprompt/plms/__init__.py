...
from .BertForNoCollapse import BertForNoCollapse
# from .BertForNoCollapseV2 import BertForNoCollapse

from .BertForMaskedLMV2 import BertForMaskedLM
...
_MODEL_CLASSES = {
    ...
    'BertForNoCollapse':ModelClass(**{
        'config': BertConfig,
        'tokenizer': BertTokenizer,
        'model': BertForNoCollapse,
        'wrapper': MLMTokenizerWrapper,
    }),
}
